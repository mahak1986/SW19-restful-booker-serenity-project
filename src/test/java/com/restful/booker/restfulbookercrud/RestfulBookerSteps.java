package com.restful.booker.restfulbookercrud;
...
public class RestfulBookerSteps extends TestBase {
    public static String username = "admin";
    public static String password = "password123";
    public static String firstname = "Mahak" + TestUtils.getRandomValue();
    public static String lastname = "Agarwal" + TestUtils.getRandomValue();
    public static Integer totalprice = 222;
    public static Boolean depositpaid = true;
    public static String additionalneeds = "Dinner";
